 ...
 */
export const DEMO_CLONED_SUBCOLLECTIONS: SubcollectionSpec[] = [
  { name: 'characters' },
...
export function demoStoragePrefix(groupId: string): string {
  return `groups/${groupId}/`
}

/** When a sandbox created at `nowMs` falls out of scope. */
export function demoSessionExpiresAtMs(nowMs: number): number {
