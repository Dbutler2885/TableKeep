...
export const OSE_ARMOUR_CATALOG: OseArmourTemplate[] = [
  { id: 'leather', name: 'Leather', ac: '7', costGp: 20, weightCoins: 200 },
  { id: 'chainmail', name: 'Chainmail', ac: '5', costGp: 40, weightCoins: 400 },
  { id: 'plate-mail', name: 'Plate mail', ac: '3', costGp: 60, weightCoins: 500 },
