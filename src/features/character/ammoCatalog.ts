...
export const OSE_AMMO_CATALOG: AmmoCatalogEntry[] = [
  { id: 'ammo-arrows', name: 'Arrows', costGp: 5, description: 'Quiver of 20 arrows.', qty: 20 },
  { id: 'ammo-bolts', name: 'Crossbow bolts', costGp: 10, description: 'Case of 30 bolts.', qty: 30 },
  { id: 'ammo-silver-arrow', name: 'Silver tipped arrow', costGp: 5, description: 'Single silver-tipped arrow.', qty: 1 },
